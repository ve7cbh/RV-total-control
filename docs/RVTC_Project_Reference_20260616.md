...
|---|---|---|---|---|
| RS-485/1 | 192.168.88.5 | 4001 | Power — Solar | EPEVER MPPT60 RJ45 D+ 6, D- 4| 3 |
| RS-485/2 | 192.168.88.6 | 4001 | Power — Inverter | SAMLUX EVO-2212 RJ45 D+ 4, D- 5| 3 |
| RS-485/3 | 192.168.88.7 | 4001 | Power — Grid meter | KWS-303L (grid) | 3 |
| RS-485/4 | 192.168.88.8 | 4001 | Power — Generator | KWS-303L (generator) | 3 |
| RS-485/5 | 192.168.88.9 | 4001 | Water sensors | Pressure + Filter ΔP + Turbidity | 5 |
| RS-485/6 | 192.168.88.10 | 4001 | GNSS | E108-GN03G-485 position/time receiver | 3 |
| RS-485/7 | 192.168.88.11 | 4001 | Weather station | WN90LP (HW-16) | 3 |
| RS-485/8 | 192.168.88.12 | 4001 | Power — Load shed | Waveshare 8-ch relay board (HW-13) | 3 |
...
**Interface:** RS-485 Modbus RTU — wired into the Waveshare 8-Ch RS485 Gateway (Section 2.6), port RS-485/8 (TCP 4008). No standalone Ethernet/IP interface.
**IP:** None required — reached via gateway IP 192.168.88.5, TCP 4008
...
KWS-303L grid meter (HW-08) + KWS-303L generator meter (HW-09)
  → HA automation (three conditions)
    → Waveshare 8-ch relay board, RS-485/8 (TCP 4008) — 2 relay channels
...
| HW-13 | 3 | Waveshare 8-ch RS-485 Modbus relay board — shore power load management | 🟡 Open | **Ordered 2026-06-16** — replaces DT-R016 (found inoperative on bench test); RS-485 Modbus RTU via Waveshare gateway port RS-485/8 (TCP 4008), no dedicated IP; 2 channels drive HSR1-25 relays (HW-18); prerequisite for OI-24 |
...
- Replacement ordered: Waveshare 8-channel relay board, RS-485 Modbus RTU interface (no standalone Ethernet/IP) — wired into Waveshare RS-485 gateway port RS-485/8 (TCP 4008)
...
9. Waveshare 8-ch RS-485 relay board — commission via Waveshare gateway port RS-485/8 (TCP 4008); record Modbus coil addresses for load relay channels (HW-13)
