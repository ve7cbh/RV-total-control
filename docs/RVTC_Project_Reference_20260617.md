...
| HW-13 | 3 | Waveshare 8-ch RS-485 Modbus relay board — shore power load management | 🟡 Open | **Ordered 2026-06-16** — replaces DT-R016 (found inoperative on bench test); RS-485 Modbus RTU via Waveshare gateway port RS-485/8, IP 192.168.88.12, TCP 4001; 2 channels drive HSR1-25 relays (HW-18); prerequisite for OI-24 |
