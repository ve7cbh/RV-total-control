...
| HW-10 | 3 | Install GNSS E108-GN03G-485 | ✅ Closed| RS485, IP67; Waveshare port 6, IP 192.168.88.10, TCP 4001 |
...
6. HA modbus_relay.yaml — coil control for Tier 3 load-shed automation (OI-24) — use 0-based addressing
7. Rebuild Grafana weather dashboard (OI-16)
8. WN90LP commissioning when received (HW-16)
9. Portainer container management UI (OI-37)
