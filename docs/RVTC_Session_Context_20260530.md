...
| ID | Item | Phase | Status | Notes |
|---|---|---|---|---|
| HW-01 | Install HF5142B Modbus gateway | 3 | 🟡 Open | 4-port RS-485→Ethernet; IP 192.168.88.5 already allocated |
...
**Next session:** Home Assistant onboarding (OI-15), ESPHome Ansible role (OI-18), Grafana cleanup, Phase 3 planning.
